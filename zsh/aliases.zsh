...
alias l='exa -a --long --grid --git'      # Preferred 'ls' implementation using exa for colors, grid and git
...
alias edit='${EDITOR} '                   # edit:         Opens any file in default editor
...
#   File Management
#   -----------------------------------------------------
alias du="ncdu --color dark -rr -x --exclude .git --exclude node_modules" # Overwrite builtin du to use a modern one
...
#   Web
#   ---------------------------------------
alias apacheEdit='sudo ${EDITOR} /usr/local/etc/httpd/httpd.conf'                # apacheEdit:       Edit httpd.conf
